...
.
\note[moved, nolist]{Notes that may have started here, but aren't relevant here, so their content has been moved elsewhere, where I'll actually pay attention it it.} \noindent
.
