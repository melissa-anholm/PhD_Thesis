...
%\vspace{-24pt}
%\setstretch{1.1}
There are four fundamental forces known to exist within the natural world:  electromagnetism, gravity, the strong nuclear force, and the weak nuclear force.  One of the primary windows to the inner workings of the weak nuclear force has long been found in observations of beta decay processes.  Of particular interest is the form taken by the couplings involved in beta decay; although prior experiments have shown that the process is dominated by a combination of so-called vector and axial couplings, the possibility of a non-dominant contribution from exotic scalar or tensor couplings remains.  Such a discovery would shake the foundations upon which our understanding of the weak force is built.

%Although much is known about the behaviour of the weak force, 
%major vehicles through which the weak nuclear force c
%One of the primary vehicles through which the weak nuclear force can be understood and analyzed is 

%
A precision kinematic measurement of the beta decay process $\mbox{$^{37}$K$ \, \rightarrow \, ^{37}$Ar $ +\, \beta^+ + \nu_e$}$ is conducted to search for- or constrain exotic couplings within the nuclear weak force by measuring observable known as the Fierz interference ($\bFierz$).  This effect, if present, would manifest as a perturbation to the expected shape of the energy spectrum for betas emerging from a decay, and would be a definitive indication of the presence of scalar or tensor couplings.

%
%An observable known as the Fierz interference ($\bFierz$) 
%which is comprised of a linear combination of any scalar and tensor couplings present in nature.  
%This effect, if present, would manifest as a perturbation to the expected shape of the energy spectrum for betas emerging from a decay.  
%
%The search is performed by kinematic observations of the outgoing particles within the decay process, $^{37}$K$ \, \rightarrow \, ^{37}$Ar $ +\, \beta^+ + \nu_e$.  
Measurements are carried out within the TRINAT laboratory located at TRIUMF, which provides the radioactive $^{37}$K necessary for the experiment.  The TRINAT apparatus provides the means to cool, confine, and intermittently spin-polarize $^{37}$K atoms within a magneto-optical trap.  Upon decay, outgoing particles are emitted from a small central cloud into an open geometry featuring a variety of detectors.  

With a thorough understanding of the polarization, and a \emph{fractional} effect that changes size with the relative angle between the directions of polarization and beta emission, the superratio technique is able to provide an elegant mathematical tool to greatly decrease the size of many systematic uncertainties, at the cost of some statistical power.  Geant4 simulations are used to model scattering effects and background events that could mimic the signal being searched for.  The resulting measurement gives \, $\mbox{\!$\bFierz = +0.033 \pm 0.084(\textrm{stat}) \pm 0.039(\textrm{sys})$}$, consistent with the absence of exotic scalar and tensor couplings.
...
% 
\note{prospective abstract first paragraph, now in the intro chapter: 
\\...\\
