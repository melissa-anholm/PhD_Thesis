...
\section{Polarization Cycle Selection}
	Data used for our collaboration's Ref.~\cite{ben_Abeta} was slightly less polarized than previously thought, due to an oversight in the data selection procedure.  See Ch.~\ref{sec:compare_Abeta} for a discussion of the effects.
