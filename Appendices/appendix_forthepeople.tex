...
\note{They start with the Lee-Yang Hamiltonian in Eq.~\ref{eq:lee_yang_hamiltonian}, with the pseudoscalar terms dropped for convenience, as they're suppressed anyway.}
...
%}
\note{Also define:  $G_v$, $\theta_c$, $\hat{n}$, $\Lambda_i$}
