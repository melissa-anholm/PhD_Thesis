...
%we must find a regime in which the two 

%, with the matrix elements $M_F$ and $M_{GT}$ being unique to each nucleus, and the $C_X$ and $C_X^\prime$ .
% in order to account for both left-handed and right-handed couplings.
