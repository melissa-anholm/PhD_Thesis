...
\label{setup_chapter}
\note[color=jb]{JB:  First, I'm pretty sure you should combine Chs. 3 and 4.
...
\note[color=done]{JB says:  chapter 4.1 (this section) is really good, and in good shape for the committee}
...
\label{section:mcps}
\note[color=jb]{JB says of Chapter 4.3 (this section:  first few paragraphs are poorly phrased. You have to fix those.  Most of the rest looks really good.  }
...
\note[color=jb]{Chapter 4.4 (this section!) is very good and complete, showing you understand what is
