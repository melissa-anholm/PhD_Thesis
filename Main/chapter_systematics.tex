...
\note[color=jb]{ Here is Subsection 9.5.5 "The low-energy tail uncerainty, and what it does''
complete.
There should be no figure.
You cite the Clifford paper now in other sections-- please check if my \cite{} is right.
(I cc: everyone as my summary of the situation that I showed Dec 1, 2021 at trinat.triumf.ca)
}
\note[color=jb]{
*************************************
\\
...
with linewidth varying by photon statistics~\cite{Clifford1984?}.
