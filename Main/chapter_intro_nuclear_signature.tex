...
\note[jbnn]{John says:  "the Feynman anecdote I did not relay correctly and should be cut"}
\note[jbnn]{btw2, you should drop ``who credits Feynman for the suggestion.''
\\
...
\note[jm]{``On page 22, the ``sudden approximation'' is used but is never defined.''}
\note[jbnn]{4. "sudden approximation"
\\...\\
