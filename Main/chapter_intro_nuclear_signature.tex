...
%
By constrast, the electromagnetic force couples to both positive and negative electric charges, and can produce both attractive and repulsive forces.  Both the electromagnetic and gravitational forces are mediated by massless force-carrying particles (the photon and graviton, respectively), a property which implies that the amount of flux per unit solid angle is constant over all distance scales, and Gauss's Law holds true.
...
In Fig.~\ref{fig:feynmandiagrams_betadecay} the Feynman diagrams pertaining to the most common beta decay processes are shown.

\FloatBarrier
\begin{figure}[h!t!b!]
	\centering
	\includegraphics[width=.999\linewidth]{Figures/feynmandiagrams_betadecay_placeholder.jpeg}
...
%Things to go here.
\begin{itemize}
%	\item list of feynman diagrams.  probably within that picture. 
	\item (we're not proposing a new feynman diagram.  Just, a new vertex factor thingy, I guess.)
	\item weak force is pretty well understood.... sort-of.
...
Pauli's 1931 insight paved the way for Enrico Fermi to propose a quantitative description of the beta decay process.  Now known as Fermi's Golden Rule, the introduction of this model in 1934 arguably marks the beginning of our modern understanding of beta decay.  Fermi's Golden Rule is both remarkably general in its approach, as well as powerful in its predictive power, approaching the matter from a fully quantum mechanical perspective.  \aside{Point to that other section where I math this out.}

On the experimental front, 1934 also marks the first discovery of $\beta^+$ radiation, for which Irène and Frédéric Joliot-Curie later received a Nobel prize.  1934 was also the year when Wick proposed the electron capture mechanism for beta decay, later observed by Luis Alvarez in 1937.  \aside{Yukawa and others totes helped flesh out the theory behind E.C.}
