...
Comparing this result to Eq.~(\ref{eq:Ft_with_Vud}), it is immediately clear that these two expressions are closely related:
\bea
\mathcal{F}t^{\mathrm{mirror}}
&=& 
