...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%\FloatBarrier
%%%\note[done, nolist]{From Georg Schreckenbach:
%%%\\
...
%\note{This section is problematic....}
%%%%%%%%%
%%
...
%\note[done,nolist]{This is where I'm suggesting a little more explanation of Lee and Yang, and  V-A from Feynman and Gell-Mann}
...
\note[done, nolist]{John's equation for $\bFierz$ is wrong.  Use mine.}
