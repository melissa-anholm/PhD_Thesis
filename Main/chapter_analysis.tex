...
\note[color=jb]{JB says:  ``ch 7 (now ch.6) looks fine to me.''  ...even in spite of the giant paragraph suggestions below, I guess.}
\note[color=org]{Do I actually want to combine this with Chapter~\ref{calibrations_chapter}?}
\note[color=org]{from JB:  you ask at the start if you should combine it (Ch.7 (now Ch.6), `Analysis') with Ch.6 (now Ch.5) `Calibrations'. I see no special reason either way.  I would say the topics seem distinct.}
