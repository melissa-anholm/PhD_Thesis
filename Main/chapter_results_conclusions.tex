...
\note[color=jb]{JB on Ch. ~\ref{sec:measured_limits}:
\\...\\
...
%\note[color=tag]{Write Discussion Section.}
...
\note[color=org]{I have legit just deleted a section in Ch.6:  "Relation to Other Measurements and New Overall Limits".  It's gone now.  Because it was stupid.  Only John's comments about what it might do in the future remain.}
\note[color=jb]{JB on Ch.~\ref{sec:relation_to_other_measurements}:  "Relation to Other Measurements and New Overall Limits"
\\
...
\note[color=org]{End of John's comments on the section I deleted.}
...
\note[color=jb]{JB on Ch. \ref{sec:discussion_corrections_uncertainties} -- `discussion of corrections and uncertainties':
\\...\\
...
\note[color=tag]{put in that thing John said.}
