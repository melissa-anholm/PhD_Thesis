...
%\note{For the actual beamtime, the image was clearly not centered correctly anymore, so this had to be re-estimated.  it's probably due to the addition or removal of cables creating or eliminating a delay in the readouts. }
...
%	\note{It wasn't possible to eliminate the stripes in analysis.}
