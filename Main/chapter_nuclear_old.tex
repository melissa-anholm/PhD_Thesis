...
%\note[color=jb]{JB says Chapter 1 sections 1.1 and 1.3 should get moved here into Chapter 2.}
%\note[color=jb]{JB on what (else) should change in Chapter 2 (soon to be chapter 1):
%\\
%...
%\\
%cut "so we will simply provide the combined master equation here"
%\\
