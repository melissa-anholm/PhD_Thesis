...
\label{sec:lineshape_results}
	\note[color=org]{I think I'm going to put most of the content in this section into the `Simulations' chapter (Section~\ref{sec:responsefunction}) instead.  I really need to just mention it here (Sec.~\ref{sec:lineshape_results}) and give an indication of how good the result is.  Then evaluate stuff.}
