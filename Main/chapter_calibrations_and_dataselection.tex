...
\note{Potential new subsection:  the camera?}
...
%
\note[color=jb]{JB says:  ``((Ch.~\ref{analysis_chapter})) looks fine to me.''  ...even in spite of the giant paragraph suggestions below, I guess.}
...
\note[color=jb]{John proposes an intro statement for this chapter.  I think it probably goes in a different chapter now.  But anyway, the following two paragraphs are a direct quote from him:}
